class ScrapedProduct:
    ...
    def __repr__(self):
        return f"ScrapedProduct({self.uid}, {self.average_rating}, {self.product_code}, {self.brand}, {self.name}, {self.price}, {self.formatted_price}, {self.promotions}, {self.is_in_stock}, {self.default_sku}, {self.url}, {self.latest_price}, {self.variant_code}, {self.variant_info}, {self.stock_level})"
